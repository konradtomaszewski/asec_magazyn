...
$_SESSION['mysql'] = ['host'=>'localhost', 'user'=>'kondzik', 'pass'=>'cieszyryjek', 'dbname'=>'mennica_magazyn'];
if(isset($_SESSION['mysql'])){
  ...
  if($tables['er'] =='') $html .= '<h2 id="tab_frm_cht" class="tabvi">'. $bk->langTxt('msg_show_tables') .'</h2><h2 id="tab_frm_zip">'. $bk->langTxt('msg_show_files') .'</h2><br>'. $tables['f'] . $bk->getListZip($dir);
