...
$(document).ready(function(){
	...
	//$('#storage_select').change(function(){
		...
		var storage_id = $( "#storage_select option:selected" ).val();
...
<div id="main">
	<article class="post">
		...
		<section id="section_form">
			...
			<select id="storage_select" disabled>
			<option selected disabled>Wybierz z listy</option>
			<?php
				echo "<option value=".$mennica_magazyn_storage_id." selected>".$mennica_magazyn_storage_name."</option>";
