...
echo "<div id='broken_arrival_list'>";
	if($vectorsoft_magazyn->report_broken_devices($date_of, $date_to, $storage_id) != null)
	{
		...
		echo "<tbody>";
		$x=0;
			foreach($vectorsoft_magazyn->report_broken_devices($date_of, $date_to, $storage_id) as $row)
			{
				$x++;
				echo "<tr>";
				echo "<td>".$x.".</td>";
