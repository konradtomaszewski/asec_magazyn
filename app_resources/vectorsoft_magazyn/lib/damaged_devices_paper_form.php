...
$(document).ready(function(){
	...
	$("#export2excel").click(function(){
		$(".table2excel").table2excel({
			exclude: ".noExl",
			name: "Worksheet Name",
			filename: "Lista papieru pobranego z automatów <?php echo date('Y-m-d')?>",
			fileext: ".xls"
		}); 
	});
...
if($vectorsoft_magazyn->getDamagedDevices_only_paper($_SESSION['mennica_magazyn_storage_id']))
{
	echo "<h3>Lista papieru pobranego z automatów</h3><br />";
	...
	$x=1;
	foreach($vectorsoft_magazyn->getDamagedDevices_only_paper($_SESSION['mennica_magazyn_storage_id']) as $row)
	{
