...
$mennica_magazyn_storage_id = $_SESSION['mennica_magazyn_storage_id'];
$mennica_magazyn_storage_name = $_SESSION['mennica_magazyn_storage_name'];
?>
<style>
...
$(document).ready(function(){
	...
	$("#send_form").click(function() {
		var storage_id = $( "#arrival_storage_id :selected" ).val();
	...
	<article class="post">
		...
		<section id="section_form">
			...
			<form action="#" method="post" id="delivery_form">
				<select name="arrival_storage_id" id="arrival_storage_id" disabled>
					<option disabled="disabled" selected>Wybierz z listy</option>
					<?php
					echo "<option value=".$mennica_magazyn_storage_id." selected disabled=disabled>".$mennica_magazyn_storage_name."</option>";
