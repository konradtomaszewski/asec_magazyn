...
<?php
$denied_users_id = array('55','56','57','58','59','74','83','84');
...
<div id="main">
		...
		<div id="allow">
			<article class="post">
				...
				<section>
				<?php
					$denied = in_array($current_user_id,$denied_users_id);
					if($denied){
						echo 'Użytkownik <b>'.$_SESSION['mennica_magazyn_user_name'].'</b> nie ma uprawnień na podejmowanie działań serwisowych';
					}
					else{
						echo '<div id="productSelect_form"></div>';
						echo '<div id="productDetail_form"></div>';
					}
				?>							
				<span></span>
				</section>
