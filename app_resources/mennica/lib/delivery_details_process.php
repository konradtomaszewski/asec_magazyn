...
$delivary_details = $vectorsoft_magazyn->getDelivery_details($_POST['document_name'], $_POST['storage_id']);

echo "<br /><h2>Informacje o dokumencie: ".$delivary_details[0]['document_name']."</h2><br />";
...
echo "<th>Ilość</th>";
echo "</thead>";
foreach($vectorsoft_magazyn->getDelivery_details($_POST['document_name'], $_POST['storage_id']) as $row)
{
