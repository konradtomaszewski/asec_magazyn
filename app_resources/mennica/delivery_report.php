...
<script>
 $(document).ready(function(){
	...
	/*$( "#time_of" ).datepicker({ 
		dateFormat: 'yy-mm-dd'
	}, $.datepicker.regional['pl']).change(function(){
	...
	$('#delivery_report_btn').click(function(){
		...
		$.ajax({
				url: "app_resources/"+$.cookie('module')+"/lib/delivery_report_process.php",
				type: "POST",
				...
				error: function(data){
					$.notify('B³¹d pobierania danych', 'error');
				}
		});
	});
});
...
#delivery_report_btn{
  ...
  <div id="main">
	<article class="post">
		<header>
			<div class="title"><h3>Raport z dostaw</h3></div>
